...
## Docs
awslocal sqs create-queue --queue-name document-queue-dlq
...
## Case Creator
awslocal sqs create-queue --queue-name ukvi-complaint-queue-dlq
...
## Migration
awslocal sqs create-queue --queue-name migration-queue-dlq
